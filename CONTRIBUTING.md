...
1. Have full test coverage on the new or changed code.
2. Update the README.md with details of changes to any interface.
3. Ensure all build and tests passes before issue the pull request.
...
reported by contacting the project team at eng@applause.com. All
